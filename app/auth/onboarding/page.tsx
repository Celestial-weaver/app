      ...
      <Card className="w-full max-w-md shadow-xl border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="text-center pb-6">
          <div className="mb-4">
            ...
            <div className="text-xs text-gray-500 mb-2">{progress}% Complete</div>
          </div>
          <CardTitle className="text-2xl font-bold text-gray-900">Complete Your Registration</CardTitle>
          <CardDescription className="text-gray-600">Welcome! Let's set up your Pixisphere account</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs text-gray-500">Tip: Paste your full number, we'll auto-detect the country code!</div>
            </div>
